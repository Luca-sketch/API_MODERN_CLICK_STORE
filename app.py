...
# Importação das funções de segurança
...
╔═══════════════════════════════════════════════════════════════════════════════════════════════════════════════╗                                                            
║                                                                                                               ║  
 ■  As quatro rotas abaixo são relativas a tabela (Usuario) 👤                                                  ║
...
def gerar_pdf(form: CompraIdForm):
    ...
    try:
        ...
        barcode_code = f"COMPRA{compra_id}"  # Exemplo de código para o código de barras
        barcode_value = barcode.createBarcodeDrawing('Code128', value=barcode_code, format='png')
        barcode_value.drawOn(c, 100, 650)  # Posição do código de barras
